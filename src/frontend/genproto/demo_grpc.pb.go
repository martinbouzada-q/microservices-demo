...
const (
	FavoritesService_AddFavorite_FullMethodName    = "/hipstershop.FavoritesService/AddFavorite"
	FavoritesService_GetFavorites_FullMethodName   = "/hipstershop.FavoritesService/GetFavorites"
	FavoritesService_RemoveFavorite_FullMethodName = "/hipstershop.FavoritesService/RemoveFavorite"
	FavoritesService_ClearFavorites_FullMethodName = "/hipstershop.FavoritesService/ClearFavorites"
)
...
type FavoritesServiceClient interface {
	...
	ClearFavorites(ctx context.Context, in *ClearFavoritesRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *favoritesServiceClient) AddFavorite(ctx context.Context, in *AddFavoriteRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, FavoritesService_AddFavorite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *favoritesServiceClient) GetFavorites(ctx context.Context, in *GetFavoritesRequest, opts ...grpc.CallOption) (*GetFavoritesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFavoritesResponse)
	err := c.cc.Invoke(ctx, FavoritesService_GetFavorites_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *favoritesServiceClient) RemoveFavorite(ctx context.Context, in *RemoveFavoriteRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, FavoritesService_RemoveFavorite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *favoritesServiceClient) ClearFavorites(ctx context.Context, in *ClearFavoritesRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, FavoritesService_ClearFavorites_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FavoritesServiceServer interface {
	...
	ClearFavorites(context.Context, *ClearFavoritesRequest) (*Empty, error)
...
func (UnimplementedFavoritesServiceServer) AddFavorite(context.Context, *AddFavoriteRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddFavorite not implemented")
}
func (UnimplementedFavoritesServiceServer) GetFavorites(context.Context, *GetFavoritesRequest) (*GetFavoritesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetFavorites not implemented")
}
func (UnimplementedFavoritesServiceServer) RemoveFavorite(context.Context, *RemoveFavoriteRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveFavorite not implemented")
}
func (UnimplementedFavoritesServiceServer) ClearFavorites(context.Context, *ClearFavoritesRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ClearFavorites not implemented")
}
...
func _FavoritesService_AddFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FavoritesService_AddFavorite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FavoritesService_GetFavorites_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFavoritesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FavoritesServiceServer).GetFavorites(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FavoritesService_GetFavorites_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoritesServiceServer).GetFavorites(ctx, req.(*GetFavoritesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _FavoritesService_RemoveFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FavoritesService_RemoveFavorite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FavoritesService_ClearFavorites_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClearFavoritesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FavoritesServiceServer).ClearFavorites(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FavoritesService_ClearFavorites_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoritesServiceServer).ClearFavorites(ctx, req.(*ClearFavoritesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FavoritesService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.FavoritesService",
	HandlerType: (*FavoritesServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddFavorite",
			Handler:    _FavoritesService_AddFavorite_Handler,
		},
		{
			MethodName: "GetFavorites",
			Handler:    _FavoritesService_GetFavorites_Handler,
		},
		{
			MethodName: "RemoveFavorite",
			Handler:    _FavoritesService_RemoveFavorite_Handler,
		},
		{
			MethodName: "ClearFavorites",
			Handler:    _FavoritesService_ClearFavorites_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
