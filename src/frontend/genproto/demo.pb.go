...
type Favorite struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProductId     string                 `protobuf:"bytes,1,opt,name=product_id,json=productId,proto3" json:"product_id,omitempty"`
	AddedAt       string                 `protobuf:"bytes,2,opt,name=added_at,json=addedAt,proto3" json:"added_at,omitempty"` // RFC3339 timestamp (ISO 8601 format)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Favorite) GetAddedAt() string {
	if x != nil {
		return x.AddedAt
	}
	return ""
...
type AddFavoriteRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Session ID
...
const file_demo_proto_rawDesc = "" +
	...
	"\badded_at\x18\x02 \x01(\tR\aaddedAt\"L\n" +
	...
	"\x14GetFavoritesResponse\x123\n" +
	"\tfavorites\x18\x01 \x03(\v2\x15.hipstershop.FavoriteR\tfavorites\"O\n" +
	...
	"\tAdService\x12;\n" +
	"\x06GetAds\x12\x16.hipstershop.AdRequest\x1a\x17.hipstershop.AdResponse\"\x002\xc7\x02\n" +
	"\x10FavoritesService\x12D\n" +
	"\vAddFavorite\x12\x1f.hipstershop.AddFavoriteRequest\x1a\x12.hipstershop.Empty\"\x00\x12U\n" +
	"\fGetFavorites\x12 .hipstershop.GetFavoritesRequest\x1a!.hipstershop.GetFavoritesResponse\"\x00\x12J\n" +
	"\x0eRemoveFavorite\x12\".hipstershop.RemoveFavoriteRequest\x1a\x12.hipstershop.Empty\"\x00\x12J\n" +
	"\x0eClearFavorites\x12\".hipstershop.ClearFavoritesRequest\x1a\x12.hipstershop.Empty\"\x00BIZGgithub.com/GoogleCloudPlatform/microservices-demo/src/frontend/genprotob\x06proto3"
...
var file_demo_proto_goTypes = []any{
	...
	(*Favorite)(nil),                       // 32: hipstershop.Favorite
	(*AddFavoriteRequest)(nil),             // 33: hipstershop.AddFavoriteRequest
	(*GetFavoritesRequest)(nil),            // 34: hipstershop.GetFavoritesRequest
	(*GetFavoritesResponse)(nil),           // 35: hipstershop.GetFavoritesResponse
	(*RemoveFavoriteRequest)(nil),          // 36: hipstershop.RemoveFavoriteRequest
	(*ClearFavoritesRequest)(nil),          // 37: hipstershop.ClearFavoritesRequest
}
var file_demo_proto_depIdxs = []int32{
	...
	32, // 23: hipstershop.GetFavoritesResponse.favorites:type_name -> hipstershop.Favorite
	...
	33, // 39: hipstershop.FavoritesService.AddFavorite:input_type -> hipstershop.AddFavoriteRequest
	34, // 40: hipstershop.FavoritesService.GetFavorites:input_type -> hipstershop.GetFavoritesRequest
	36, // 41: hipstershop.FavoritesService.RemoveFavorite:input_type -> hipstershop.RemoveFavoriteRequest
	37, // 42: hipstershop.FavoritesService.ClearFavorites:input_type -> hipstershop.ClearFavoritesRequest
	...
	5,  // 58: hipstershop.FavoritesService.AddFavorite:output_type -> hipstershop.Empty
	35, // 59: hipstershop.FavoritesService.GetFavorites:output_type -> hipstershop.GetFavoritesResponse
	5,  // 60: hipstershop.FavoritesService.RemoveFavorite:output_type -> hipstershop.Empty
	5,  // 61: hipstershop.FavoritesService.ClearFavorites:output_type -> hipstershop.Empty
