...
description: Generate detailed test cases from a ticket or description and publish them to any supported test management tool. Use when asked to "create test cases", "generate QA cases", "write test cases for TICKET-123", "crear casos de prueba", or when given a Jira ticket key and an output destination. Supports --from-jira, --from-text, and --from-markdown as input; --to-qase, --to-jira, --to-testrail, --to-xray, and --to-markdown as output adapters. Always invoke this skill when the user wants test cases derived from a ticket or feature description.
...
- **Related skills**: [`/create-sdd-ticket`](../create-sdd-ticket/SKILL.md), [`/analyze-requirements`](../analyze-requirements/SKILL.md), [`/implement-ticket`](../implement-ticket/SKILL.md).
